package com.engflow.setinput.main;

import com.engflow.setinput.genreader.GenReader;
...
public class Main {
    ...
    public static void main(String[] args) {
        String genfilePath = "com/engflow/setinput/genfile"; // Path relative to bazel-bin
